            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card <?= $card_step3 ? "card-warning" : "card-secondary collapsed-card"; ?>">
                        ...
                        <div class="card-body">
                            TODO: Insert instructions
                            <a class="btn btn-primary" href="<?= base_url("Assignments/download_zip/" . $id . ""); ?>">Download
                                Student (Release) files (ZIP)</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="card <?= $card_step3 ? "card-warning" : "card-secondary collapsed-card"; ?>">
                        <div class="card-header">
                            <h3 class="card-title"><?= get_num(0); ?>. Share notebook file directly with student´s
                                [MANUAL]</h3>
